...
import { Input, Component, Output, EventEmitter, TemplateRef, ViewChild, ElementRef, QueryList, ContentChildren, HostListener} from "@angular/core"

import {  AgmInfoWindow, LatLngBounds, LatLng, MarkerManager,
